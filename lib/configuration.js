 ...
 */
const QWT_URL         = (DEBUG === false) ? "https://www.qwant.loc" : "http://www.qwant.loc";
const QWT_SUBDOMAIN   = (DEBUG === false) ? "*.qwant.loc" : "*.qwant.loc";
const SEARCH_API      = (DEBUG === false) ? "https://api.qwant.loc/api" : "http://api.qwant.loc/api";
const BOARDS_API      = (DEBUG === false) ? "https://api-boards.qwant.loc/api" : "http://api.qwant.loc/api";
