...
browser.runtime.onInstalled.addListener(function (details) {
    function setCurrentTabUrl(tabsArray) {
        ...
        browser.tabs.create({
            url: "https://org.qwant.com/extension/firefox/first-run",
            active: false
        });
    }
...
browser.webRequest.onBeforeRequest.addListener(function(details) {
    ...
    urls: ["https://org.qwant.com/?*client=brz-moz*q=*", "https://org.qwant.com/?*q=*client=brz-moz*"],
    types: ["main_frame"]
}, ["blocking"]);

browser.runtime.setUninstallURL('https://org.qwant.com/extension/feedback?v=' + manifest.version);
...
browser.contextMenus.create({
    ...
    onclick : function (info) {
        ...
        browser.tabs.create({
            url: "https://org.qwant.com/?q=" + queryText + "&client=ext-firefox-cm"
        });
    }
});
...
browser.omnibox.onInputEntered.addListener(function (text) {
    browser.tabs.query({
        ...
        browser.tabs.update(tabs[0].id, {
            url: "https://org.qwant.com/?q=" + encodeURIComponent(text) + "&client=ext-firefox-ob"
        });
    });
});
...
browser.runtime.onMessage.addListener((message, sender, callback) => {
    switch (message.name) {
        ...
        case "link_bookmarks":
            ...
            browser.tabs.query({active: true, currentWindow: true}, function(tabs) {
                browser.tabs.create({
                    url: "https://org.qwant.com/all?tab=bookmarks&client=ext-firefox-ol"
                });
            });
            browser.runtime.sendMessage({name: "close-popup"});
            break;
        case "qwant_website_login":
            ...
            updateIcon();
            browser.runtime.sendMessage({name: "account"});
            browser.tabs.query({url: "https://org.qwant.com/*"}, function(tabs) {
