...
chrome.contextMenus.create({
    ...
    onclick : function (info) {
        ...
        chrome.tabs.create({
            url: "https://org.qwant.com/?q=" + queryText + "&client=ext-opera-cm"
        });
    }
});
...
chrome.omnibox.onInputEntered.addListener(function (text) {
    chrome.tabs.query({
        ...
        chrome.tabs.update(tabs[0].id, {
            url: "https://org.qwant.com/?q=" + encodeURIComponent(text) + "&client=ext-opera-ob"
        });
    });
});
...
chrome.runtime.onMessage.addListener((message, sender, callback) => {
    ...
    switch (message.name) {
        ...
        case "link_bookmarks":
            ...
            browser.tabs.query({active: true, currentWindow: true}, function(tabs) {
                browser.tabs.create({
                    url: "https://org.qwant.com/all?tab=bookmarks&client=ext-opera-ol"
                });
            });
            chrome.runtime.sendMessage({name: "close-popup"});
            break;
